...
import entreprenariat from '/assets/entreprenariat-femme.jpg'
import image2 from '/assets/girl4.jpg'
import scientifique from '/assets/scientist.jpg'
import PVU from '/assets/utile.jpg'
                    ...
                    <div class = {styles.second}>
                        ...
                        <div ref={refContent}>
                            <div ref={ref} data-visible = {scrollPageState() > 1 ? false : true} style={{ transform : scrollPageState() > 1  ? `translate(${-diffBetween()}px)` : `translate(0)`}}>
                                <ProgrammeItems image={entreprenariat} abr={"PPEF-ICELC"} name={"Programme de Promotion de l’Entrepreneuriat Féminin..."}/>
...
export function Carrosel({children} : any){
